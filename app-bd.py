...
if option == "Time-Series Solutions":
    ...
    if sol_type == "Prediction of Number of Death from Road Accidents":
        ...
        st.write(' ')
        st.write('Mean Absolute Error: 2.7500')
        st.write('Mean Squared Error: 14.5000')
        st.write('Root Mean Square Error: 3.8079')
        st.write('Mean Absolute Percentage Error: 28.8332')
        st.write('R2 Score: 0.7197')
        ...
        st.write('- [See the notebook](https://github.com/SumaiaParveen/Road-Accident-TS-Analysis/blob/main/LSTM%20for%20weekly%20road%20accident%20prediction.ipynb)')
